...
//--------------- Sign  Up -------------------------------------------------------------------------------------
    ...
    public void SignUpUI(){
        ...
        roleButtonGroup.add(centreManagerRB);
        ...
        centreManagerRB.setBounds(110, 200, 130, 25);
        technicianRB.setBounds(240, 200, 100, 25);
        messageLabel.setBounds(65, 50, 300, 35);
        usernameField.setBounds(125, 100, 200, 25);
        passwordField.setBounds(125, 150, 200, 25);
...
//--------------- Submit Handler -------------------------------------------------------------------------------------
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == resetButton) {
            ...
            String selectedRole = "";
            if (centreManagerRB.isSelected()) {
                selectedRole = "centre manager";
            } else if (technicianRB.isSelected()) {
            ...
            if (role != null) {
                ...
                loggedInRole = role;
                messageLabel.setText("You logged in as " + role);
